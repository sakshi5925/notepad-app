...
export default function NoteCard({ note, onDelete, onEdit, refresh }) {
        ...
        <div className="relative z-10">
          ...
          <div className="mt-4 flex items-center justify-between text-xs text-slate-400">
            ...
            <div className="flex gap-4 opacity-0 group-hover:opacity-100 transition">
              ...
              <button onClick={copyText} className="hover:text-green-400">
                {copied ? "✅" : "📋"}
              </button>

              <button onClick={onEdit} className="hover:text-yellow-400">
                ✏️
              </button>
